...
int main() {
    // while loop to be able to use break 
    while (1)
    {
        int low;
    int high;
    ...
    if (low==high)
    {
        ...
        break;    // break can't be used in main -> exit(1) achieves the same; alternate: whole program in a while loop
    }
    

    printf("\n I will generate 10 numbers bewtween %d and %d \n", low, high);
    for (int i = 0; i < 10; i++)
    {
